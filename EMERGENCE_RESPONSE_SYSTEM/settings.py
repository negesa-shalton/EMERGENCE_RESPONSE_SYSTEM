"""
Django settings for EMERGENCE_RESPONSE_SYSTEM project.
...
SECRET_KEY = "django-insecure-1=kr_(4h1$+_ec7os7hyiwo3i#^$8#e*y^9y7o7xg(r*h5zysr"
...
WSGI_APPLICATION = "EMERGENCE_RESPONSE_SYSTEM.wsgi.application"
